create table app_language (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, country nvarchar(2) not null, language nvarchar(2) not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
...
create table app_permission (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table app_permission_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, attribute nvarchar(255), primary key (id)) engine=InnoDB;
create table app_role (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
...
create table app_language_l10n_seq (next_val bigint) engine=InnoDB;
insert into app_language_l10n_seq values ( 1 );
create table attribute_status (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table attribute_status_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, attribute nvarchar(255), primary key (id)) engine=InnoDB;
create table attribute_status_transition (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, version bigint not null, active bit not null, deleted bit not null, origin nvarchar(255) not null, sort_order integer, target nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table attribute_status_transition_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, transition nvarchar(255), primary key (id)) engine=InnoDB;
...
create table attribute_status_l10n_seq (next_val bigint) engine=InnoDB;
insert into attribute_status_l10n_seq values ( 1 );
create table attribute_status_transition_l10n_seq (next_val bigint) engine=InnoDB;
insert into attribute_status_transition_l10n_seq values ( 1 );
create table attribute_type_l10n_seq (next_val bigint) engine=InnoDB;
insert into attribute_type_l10n_seq values ( 1 );
...
create table gender (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table gender_l10n_seq (next_val bigint) engine=InnoDB;
insert into gender_l10n_seq values ( 1 );
create table gender_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, attribute nvarchar(255), primary key (id)) engine=InnoDB;
create table permission_l10n_seq (next_val bigint) engine=InnoDB;
insert into permission_l10n_seq values ( 1 );
create table race_event (id bigint not null, created_date datetime not null, description nvarchar(255), end datetime, last_modified_date datetime, name nvarchar(255), start datetime, version bigint not null, created_by_id bigint, last_modified_by_id bigint, status_id nvarchar(255) not null, primary key (id)) engine=InnoDB;
create table race_event_status (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, origin nvarchar(255) not null, sort_order integer, version bigint not null, attribute_type nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table race_event_status_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, attribute nvarchar(255), primary key (id)) engine=InnoDB;
create table race_event_status_transition (id nvarchar(255) not null, created_date datetime not null, last_modified_date datetime, version bigint not null, active bit not null, deleted bit not null, origin nvarchar(255) not null, sort_order integer, target nvarchar(255) not null, created_by_id bigint, last_modified_by_id bigint, status nvarchar(255), primary key (id)) engine=InnoDB;
create table race_event_status_transition_l10n (id bigint not null, created_date datetime not null, language_code nvarchar(255) not null, last_modified_date datetime, type nvarchar(255) not null, value nvarchar(2000) not null, version bigint not null, created_by_id bigint, last_modified_by_id bigint, transition nvarchar(255), primary key (id)) engine=InnoDB;
create table race_event_status_l10n_seq (next_val bigint) engine=InnoDB;
insert into race_event_status_l10n_seq values ( 1 );
create table race_event_status_transition_l10n_seq (next_val bigint) engine=InnoDB;
insert into race_event_status_transition_l10n_seq values ( 1 );
create table race_event_seq (next_val bigint) engine=InnoDB;
insert into race_event_seq values ( 1 );
create table role_l10n_seq (next_val bigint) engine=InnoDB;
insert into role_l10n_seq values ( 1 );
...
alter table app_language add constraint FKcrfolfp61bj6wlo8y6wtojep4 foreign key (status) references attribute_status (id);
...
alter table app_permission add constraint FK6mnlatrpcobombmm2ooqqwhom foreign key (status) references attribute_status (id);
...
alter table app_role add constraint FKgh1wvr23wmqlb4qs609qcq1xn foreign key (status) references attribute_status (id);
...
alter table attribute_status add constraint FKno6ohoqdoq779y2k98s0yli1 foreign key (attribute_type) references attribute_type (id);
alter table attribute_status add constraint FKbc05jo4suq09m47n28s5nq4gi foreign key (created_by_id) references app_user (id);
alter table attribute_status add constraint FKl5g2o3q6ypr1c91r3fmiq517o foreign key (last_modified_by_id) references app_user (id);
alter table attribute_status add constraint FK4eq7v7t400vvdoy6re1imnhm9 foreign key (status) references attribute_status (id);
alter table attribute_status_l10n add constraint FKtm4h8fclvd5rvgb2qc4nfvm82 foreign key (created_by_id) references app_user (id);
alter table attribute_status_l10n add constraint FKlxpxobkusen977lvydfa6tsdx foreign key (last_modified_by_id) references app_user (id);
alter table attribute_status_l10n add constraint FKomhrl3jj20516t2yj7hb78da foreign key (attribute) references attribute_status (id);
alter table attribute_status_transition add constraint FK2sdcp4scue5w7oimkakknyulr foreign key (created_by_id) references app_user (id);
alter table attribute_status_transition add constraint FKg0xkhqfsfcnd18b5byxawp7t1 foreign key (last_modified_by_id) references app_user (id);
alter table attribute_status_transition add constraint FKlphp1obx8mhiv42iyn91qt6e1 foreign key (status) references attribute_status (id);
alter table attribute_status_transition_l10n add constraint FKlaiyepqgc7wfm3jx5i2mb4cgp foreign key (created_by_id) references app_user (id);
alter table attribute_status_transition_l10n add constraint FKqiaad40hmcq6328t2alj2j4ww foreign key (last_modified_by_id) references app_user (id);
alter table attribute_status_transition_l10n add constraint FKa9ajtfmanp81iksfdv7aooq0f foreign key (transition) references attribute_status_transition (id);
...
alter table gender add constraint FK6xnrvfr7fjow3ggwbjw42a7sm foreign key (status) references attribute_status (id);
...
alter table race_event add constraint FKov3x4r2cgt8nqnlsgsquongco foreign key (created_by_id) references app_user (id);
alter table race_event add constraint FKsubsgjy4pk2ap566a4my19ox1 foreign key (last_modified_by_id) references app_user (id);
alter table race_event add constraint FKnmc62hlldddmjcw42pc28qn4o foreign key (status_id) references race_event_status (id);
alter table race_event_status add constraint FKb5evvqd2iqh9y292vthqd4brr foreign key (attribute_type) references attribute_type (id);
alter table race_event_status add constraint FKsx941sfgq2wi1lvehstnfdht8 foreign key (created_by_id) references app_user (id);
alter table race_event_status add constraint FK9hpmd8inf4dgbf4yx422h1mwu foreign key (last_modified_by_id) references app_user (id);
alter table race_event_status add constraint FKk4y89afdsypb3vjb7lshdmxdg foreign key (status) references attribute_status (id);
alter table race_event_status_l10n add constraint FK99ulw7tl5b4aof9htkjgn2j10 foreign key (created_by_id) references app_user (id);
alter table race_event_status_l10n add constraint FKe7hgnsg9act5feo3x74vjgra4 foreign key (last_modified_by_id) references app_user (id);
alter table race_event_status_l10n add constraint FK4ahlers6yqpxjqbkudm23h6hh foreign key (attribute) references race_event_status (id);
alter table race_event_status_transition add constraint FK9682qqgov2iily16uo5cbhlo2 foreign key (created_by_id) references app_user (id);
alter table race_event_status_transition add constraint FKm21c6y6f9vqnf4ltjpg8k55dd foreign key (last_modified_by_id) references app_user (id);
alter table race_event_status_transition add constraint FKdrpkgw0l8la73ex5l2nsb55bm foreign key (status) references race_event_status (id);
alter table race_event_status_transition_l10n add constraint FK5do7l0ncd70him6a8gpcbj0mg foreign key (created_by_id) references app_user (id);
alter table race_event_status_transition_l10n add constraint FKhxggber7u4fbq32ix871r1i61 foreign key (last_modified_by_id) references app_user (id);
alter table race_event_status_transition_l10n add constraint FK2ha2oypw3aa146nkgsyyw0d2f foreign key (transition) references race_event_status_transition (id);
